(function () {
  ...
  function openVkCommunityTokenDrawer() {
    openDrawer('VK / ТОКЕН', 'Токен сообщества', `<form id="vk-community-form">
      <p class="drawer-note">Нужен, чтобы публиковать <strong>посты, фото и записи на стене</strong> сообщества. Видео работает отдельно — через кнопку «Подключить». Вставить нужно один раз.</p>
      <ol class="autopost-help-steps">
